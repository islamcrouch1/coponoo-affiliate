    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
              ...
              <tbody>
                  <tr>
                    ...
                    <td>
                        ...
                        <img alt="Avatar" class="table-avatar" src="{{ asset('storage/images/icon.png') }}">

                        @else
                        <img alt="Avatar" class="table-avatar" src="{{ $notification->user_image }}">
          ...
          @else <h3 class="pl-2">{{__('No notifications To Show')}}</h3>
          @endif
        </div>
        <!-- /.card-body -->
      </div>
