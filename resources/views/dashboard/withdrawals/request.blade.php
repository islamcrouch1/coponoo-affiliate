        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('withdrawals.affiliate.store', ['lang' => app()->getLocale(), 'user' => $user->id]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="amount" type="number" min="300"
                                        max="{{ $user->balance->available_balance + $user->balance->bonus }}"
                                        class="form-control @error('amount') is-invalid @enderror" name="amount" value="300"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="data" type="text"
                                        ...
                                        value="{{ old('data') }}" autocomplete="name" required autofocus>
                            ...
                            <div class="form-group row">
                                <label for="code" class="col-md-2 col-form-label">
                                    ...
                                    <button id="send-conf"
                                        ...
                                        type="submit" class="btn btn-primary btn-sm resend">
