    ...
    <div class="row justify-content-center">
        <div class="col-md-8 m-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url(app()->getLocale() . '/dashboard/users' )}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select class=" form-control @error('role') is-invalid @enderror" id="inlineFormCustomSelectPref" id="role" type="role" name="role" value="{{ old('role') }}" required>
