        ...
        <div class="card-body p-0">
          ...
          <table class="table table-striped projects">
              <thead>
                  ...
                  <?php if($messages !== Null){$message = $messages[0];} ?>
                  @if ($message->trashed())
                  <th>
                    {{__('Deleted At')}}
                  </th>
              ...
              <tbody>
                  <tr>
                    ...
                    <td class="project-actions">
                        ...
                        <a class="btn btn-info btn-sm" href="{{route('users.show' , ['lang'=>app()->getLocale() , 'user'=>$message->user_id])}}">
          ...
          @else <h3 class="p-2">{{__('No messages To Show')}}</h3>
          @endif
        </div>
        <!-- /.card-body -->
      </div>
