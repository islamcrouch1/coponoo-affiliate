...
@section('adminContent')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            @if (auth()->user()->hasPermission('categories-create'))
                                <a href="{{ route('categories.create', app()->getLocale()) }}"> <button type="button"
                                        class="btn btn-primary">Create Category</button></a>
                            @else
                                    ...
                                    <td>
                                        <small>
                                            <a href="{{ route('products.index', ['category_id' => $Category->id, 'lang' => app()->getLocale()]) }}"
                                                class="btn btn-primary">related products</a>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        @if (!$Category->trashed())
                                            @if (auth()->user()->hasPermission('categories-update'))
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('categories.edit', ['lang' => app()->getLocale(), 'category' => $Category->id]) }}">
                                        ...
                                        @else
                                            @if (auth()->user()->hasPermission('categories-restore'))
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('categories.restore', ['lang' => app()->getLocale(), 'category' => $Category->id]) }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>
                                                    {{ __('Restore') }}
                                                </a>
    ...
    auth()->user()->hasPermission('categories-trash'))
                                            <form method="POST"
                                                action="{{ route('categories.destroy', ['lang' => app()->getLocale(), 'category' => $Category->id]) }}"
