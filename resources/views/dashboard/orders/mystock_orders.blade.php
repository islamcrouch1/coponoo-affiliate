            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-info" href="{{route('mystock.orders' , ['lang' => app()->getLocale() , 'user' => Auth::id() ,  'status' => 'pending'])}}">{{__('pending') . ' ( ' . \App\Aorder::where('user_id' , Auth::id())->where('status' , 'pending')->count() . ' )'}}</a>
                            <a class="btn btn-info" href="{{route('mystock.orders' , ['lang' => app()->getLocale() , 'user' => Auth::id() ,  'status' => 'confirmed'])}}">{{__('confirmed') . ' ( ' . \App\Aorder::where('user_id' , Auth::id())->where('status' , 'confirmed')->count() . ' )'}}</a>
                            <a class="btn btn-info" href="{{route('mystock.orders' , ['lang' => app()->getLocale() , 'user' => Auth::id() ,  'status' => 'rejected'])}}">{{__('rejected') . ' ( ' . \App\Aorder::where('user_id' , Auth::id())->where('status' , 'rejected')->count() . ' )'}}</a>
                            <a class="btn btn-info" href="{{route('mystock.orders' , ['lang' => app()->getLocale() , 'user' => Auth::id() ,  'status' => 'canceled'])}}">{{__('canceled') . ' ( ' . \App\Aorder::where('user_id' , Auth::id())->where('status' , 'canceled')->count() . ' )'}}</a>
                        </div>
                          ...
                          <tr>
                                ...
                                <td class="project-actions">
                                    ...
                                    @if ($order->status == 'pending')
                                        ...
                                        <a style="color:#ffffff"  class="btn btn-danger btn-sm" href="{{route('mystock.cancel' , ['lang' => app()->getLocale() , 'order' => $order->id] ) }}">
                                            {{__('Cancel')}}
                                        </a>
