                                    ...
                                    <div class="mt-4">
                                        <div class="btn btn-primary btn-lg btn-flat">
                                            ...
                                            <a id="cart-{{ $product->id }}" class="add-to-cart add-cart" href="#"
                                                ...
                                                data-locale="{{ app()->getLocale() }}" data-type="0"
                                                ...
                                                <div id="loader-{{ $product->id }}" style="display:none; color:#ffffff "
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-4">
                                        <div class="btn btn-info btn-lg btn-flat">
                                            ...
                                            <a href="{{ route('mystock.add', ['lang' => app()->getLocale(), 'product' => $product->id]) }}"
                                                style="color:#ffffff">
                                                <i class="fas fa-cubes fa-lg mr-2"></i> {{ __('Add to my stock') }}
                                            </a>
