                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6" style="margin-top: 60px">
                            ...
                            <form method="POST"
                                action="{{ route('mystock.order', ['lang' => app()->getLocale(),'product' => $product->id,'price' => $product->vendor_price]) }}">
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">{{ __('Select the required quantities') }}
                                                </h3>
                                            </div>
                                            <!-- /.card-header -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($product->stocks as $stock)
                                                            <tr>
                                                                ...
                                                                <td>{{ app()->getLocale() == 'ar' ? $stock->size->size_ar : $stock->size->size_ar }}
                                                                </td>
                                                                <td>{{ $stock->stock . ' ' . __('Piece') }}</td>
                                                                <td>
                                                                    <input id="quantity"
                                                                        data-price="{{ $product->min_price }}"
                                                                        data-stock="{{ $stock->stock }}" type="number"
                                                                        min="0" max="{{ $stock->stock }}"
                                                                        class="form-control product-quantity-stock quant-{{ $product->id }} @error('quantity') is-invalid @enderror"
                                ...
                                <div class="bg-primary py-2 px-3 mt-4">
                                    ...
                                    <h6 class="mb-1 mt-2">
                                        {{ __('Total order : ') }} <span id="total_order">0</span>
                                ...
                                <div class="form-group row mt-2">
                                    <label for="payment"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Select Payment method') }}</label>
                                    <div class="col-md-8">
                                        <select class=" form-control @error('payment') is-invalid @enderror" id="payment"
