    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('vendor-products.update' , ['lang'=>app()->getLocale() , 'vendor_product'=>$Product->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <thead>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td style="width:60px; height:100%; background-color:{{$stock->color->hex}}; margin-left:10px; border-radius:10px;">
                        ...
                        @else <h3 class="pl-2">{{__('No stock to show')}}</h3>
                        ...
                        <div class="row" style="margin: 30px">
                            <div class="col-md-12">
                                <a href="{{route('products.vendor.stock.add' , ['lang' => app()->getLocale() , 'product' => $Product->id])}}" class="btn btn-primary">
                                    {{ __('Edit Stock') }}
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea id="description_ar" type="text" class="form-control ckeditor @error('description_ar') is-invalid @enderror" name="description_ar"  autocomplete="description">{{ $Product->description_ar }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea id="description_en" type="text" class="form-control ckeditor @error('description_en') is-invalid @enderror" name="description_en"  autocomplete="description">{{ $Product->description_en }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="vendor_price" type="double" class="form-control @error('vendor_price') is-invalid @enderror" name="vendor_price" value="{{ $Product->vendor_price }}"  autocomplete="vendor_price">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="images" type="file" class="form-control-file img1 @error('images') is-invalid @enderror" accept="image/*" name="images[]" value="{{ old('images') }}" multiple>
                        ...
                        <div class="col-md-12 m-2" id="gallery">
                            ...
                            @foreach ($Product->images as $image)
                                <img src="{{ asset('storage/images/products/' . $image->url) }}" style="width:100px"  class="img-thumbnail img-prev">
                            @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <option value="{{ $category->id }}" {{$Product->category->id == $category->id ? 'selected' : ''}}>{{$category->name_en . ' - ' . $category->country->name_ar}}</option>
                                @endforeach
                                </select>
                                @error('category_id')
                                <span class="invalid-feedback" role="alert">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select class=" form-control @error('status') is-invalid @enderror" id="status" type="status" name="status" required>
                                    <option value="pending" {{ $Product->status == 'pending' ? 'selected' : ''}}>{{__('pending')}}</option>
                                    <option value="active" {{ $Product->status == 'active' ? 'selected' : ''}}>{{__('active')}}</option>
                                    <option value="rejected" {{ $Product->status == 'rejected' ? 'selected' : ''}}>{{__('rejected')}}</option>
                                </select>
                                @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
