                    ...
                    <form method="POST" action="{{ route('login' ,  ['lang'=>app()->getLocale() ]) }}">
                        ...
                        <div class="form-group row" id="show_hide_password">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                    ...
                                    <a style="position: absolute; top: 0px;  padding: 6px; {{app()->getLocale() == 'ar' ? 'left: 20px;' : 'right: 20px;'}}" id="show-pass" href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-link" href="{{ route('password.reset.request'  , ['lang' => app()->getLocale() , 'country' => '1']) }}">
