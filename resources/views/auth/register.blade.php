                    ...
                    <form method="POST" action="{{ route('register' ,  ['lang'=>app()->getLocale() ]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select class=" form-control @error('role') is-invalid @enderror" id="inlineFormCustomSelectPref" id="role" type="role" name="role" required>


                                    <option value="4" {{old('role') == '4' ? 'selected' : ''}}>{{__('affiliate')}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <option value="{{ $country->id }}" {{old('country') == $country->id ? 'selected' : ''}}>{{ $country->name_en }}</option>
                                @endforeach
                                </select>
                                @error('country')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="phone" type="txt" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{old('phone_hide') . old('phone')   }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input {{ old('gender') == "male" ? 'checked' : '' }} class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="inlineRadio1" value="male" required>
                                    <label class="form-check-label" for="inlineRadio1">{{ __('Male') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input {{ old('gender') == "female" ? 'checked' : '' }} class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="inlineRadio2" value="female" required>
                        ...
                        <div class="form-check">
                            <input value="checked" name="check" class="form-check-input @error('check') is-invalid @enderror" type="checkbox" value="" id="flexCheckDefault" required>
