    ...
    <!-- footer area start -->
    <footer class="footer-area text-center" style="background: url({{ asset('storage/img/shape/footer-bg-1.png') }});">
        <div class="container">
            <div class="footer-thumb">
                <a href="index.html"><img style="width: 140px; padding-top:1px" src="{{ asset('storage/images/logo.png') }}" alt="img"></a>
            </div>
            ...
            <div class="widget-footer-social">
                <ul>
                    ...
                    <li><a href="https://www.youtube.com/channel/UCUI_iyN0ZcnXN9s96CAFV-w"><i class="fab fa-youtube"></i></a></li>
                </ul>
            </div>
        </div>
        <!--Footer bottom-->
